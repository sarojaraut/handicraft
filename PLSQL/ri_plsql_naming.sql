...
CREATE OR REPLACE PACKAGE ri_plsql_naming IS
    --
    --Variables
    --
    ...
    -- Parameters
    --
    gc_in_parameter_name     CONSTANT VARCHAR2(30) := 'i\_%';
    gc_out_parameter_name    CONSTANT VARCHAR2(30) := 'o\_%';
    gc_in_out_parameter_name CONSTANT VARCHAR2(30) := 'io\_%';
    gc_cursor_parameter_name CONSTANT VARCHAR2(30) := 'i\_%';
    --
    -- Cursors
    --
    ...
    --
    gc_procedure_name CONSTANT VARCHAR2(30) := 'p_%';
    gc_function_name  CONSTANT VARCHAR2(30) := 'f_%';
    --
    -- Exception
    --
...
CREATE OR REPLACE PACKAGE BODY ri_plsql_naming IS
...
exec ri_plsql_naming.check_code('RI_PLSQL_NAMING');
